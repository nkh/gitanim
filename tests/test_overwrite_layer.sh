...
"$ROOT/bin/ad_layer_noop" < /tmp/ow_raw.txt 2>/dev/null > /tmp/ow_no.txt
...
"$ROOT/bin/ad_layer_noop" < /tmp/ow_raw.txt 2>/dev/null | \
"$ROOT/bin/ad_layer_overwrite" 2>/dev/null | \
"$ROOT/bin/ad_layer_noop" 2>/dev/null | \
"$ROOT/bin/ad_layer_pace" > /tmp/ow_timed_ow.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/ow_out_ow.txt /tmp/ow_old.txt < /tmp/ow_timed_ow.txt 2>/dev/null
...
"$ROOT/bin/ad_layer_noop" < /tmp/ow_raw.txt 2>/dev/null | \
"$ROOT/bin/ad_layer_noop" 2>/dev/null | \
"$ROOT/bin/ad_layer_pace" > /tmp/ow_timed_no.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/ow_out_no.txt /tmp/ow_old.txt < /tmp/ow_timed_no.txt 2>/dev/null
...
DV_OP_DEBUG=1 "$ROOT/bin/ad_layer_noop" < /tmp/ow_raw.txt 2>/dev/null | \
DV_OP_DEBUG=1 "$ROOT/bin/ad_layer_overwrite" 2>/dev/null > /tmp/ow_debug.txt
...
if grep -q "merge" /tmp/ad_debug/postprocess.log 2>/dev/null; then
...
"$ROOT/bin/ad_layer_noop" < /tmp/ow4_raw.txt 2>/dev/null | \
"$ROOT/bin/ad_layer_overwrite" 2>/dev/null | \
"$ROOT/bin/ad_layer_noop" 2>/dev/null | \
"$ROOT/bin/ad_layer_pace" > /tmp/ow4_timed.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/ow4_out.txt /tmp/ow4_old.txt < /tmp/ow4_timed.txt 2>/dev/null
