...
OLD="$ROOT/examples/01_small_python/old.py"
NEW="$ROOT/examples/01_small_python/new.py"
...
OLD="$ROOT/examples/02_large_python/old.py"
NEW="$ROOT/examples/02_large_python/new.py"
