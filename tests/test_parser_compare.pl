...
my $out = `perl diffvim.pl --parser-compare examples/01_small_python/old.py examples/01_small_python/new.py 2>&1`;
...
$out = `perl diffvim.pl --parser-compare examples/01_small_python/old.py examples/01_small_python/old.py 2>&1`;
...
print "\n=== Test: exit code ===\n";
system("perl diffvim.pl --parser-compare examples/01_small_python/old.py examples/01_small_python/new.py >/dev/null 2>&1");
my $rc = $? >> 8;
