...
my $out = `perl ad_vim.pl --parser-compare tests/examples/01_small_python/old.py tests/examples/01_small_python/new.py 2>&1`;
...
$out = `perl ad_vim.pl --parser-compare tests/examples/01_small_python/old.py tests/examples/01_small_python/old.py 2>&1`;
...
print "\n=== Test: exit code ===\n";
system("perl ad_vim.pl --parser-compare tests/examples/01_small_python/old.py tests/examples/01_small_python/new.py >/dev/null 2>&1");
my $rc = $? >> 8;
