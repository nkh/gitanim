...
"$ROOT/bin/ad_layer_pace" --cursor-glide-ms 100 < /tmp/mh_post.txt > /tmp/mh_timed.txt 2>/dev/null
...
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/mh_out.txt /tmp/mh_old.txt < /tmp/mh_timed.txt 2>/dev/null
...
"$ROOT/bin/ad_layer_pace" --distance-speed adaptive --distance-threshold 5 < /tmp/mh_post.txt > /tmp/mh_timed2.txt 2>/dev/null
...
"$ROOT/bin/ad_postprocess" --indent-last < /tmp/il_raw.txt > /tmp/il_post2.txt 2>/dev/null
"$ROOT/bin/ad_layer_pace" < /tmp/il_post2.txt > /tmp/il_timed.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/il_out.txt /tmp/il_old.txt < /tmp/il_timed.txt 2>/dev/null
...
"$ROOT/bin/ad_layer_pace" --delete-pacing flash < /tmp/il_post.txt > /tmp/flash_timed.txt 2>/dev/null
...
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/flash_out.txt /tmp/il_old.txt < /tmp/flash_timed.txt 2>/dev/null
...
"$ROOT/bin/ad_layer_pace" --insert-pacing word < /tmp/mh_post.txt > /tmp/iw_timed.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/iw_out.txt /tmp/mh_old.txt < /tmp/iw_timed.txt 2>/dev/null
...
"$ROOT/bin/ad" --no-display --speed 1000 --scroll zt --snapshot /tmp/scroll_out.txt /tmp/mh_old.txt < /tmp/mh_timed.txt 2>/dev/null
if [[ $? -eq 0 ]]; then
...
"$ROOT/bin/ad_layer_pace" --cursor-glide-ms 50 --distance-speed adaptive --distance-threshold 3 < /tmp/mh_post.txt > /tmp/all_timed.txt 2>/dev/null
"$ROOT/bin/ad" --no-display --speed 1000 --snapshot /tmp/all_out.txt /tmp/mh_old.txt < /tmp/all_timed.txt 2>/dev/null
...
bash "$ROOT/animator/ad_pipeline" --no-display --speed 1000 --cursor-glide-ms 50 --snapshot /tmp/launch_out.txt /tmp/mh_old.txt /tmp/mh_new.txt 2>/dev/null
...
bash "$ROOT/animator/ad_pipeline" --no-display --speed 1000 --indent-last --snapshot /tmp/launch_il_out.txt /tmp/il_old.txt /tmp/il_new.txt 2>/dev/null
...
bash "$ROOT/animator/ad_pipeline" --no-display --speed 1000 --delete-pacing flash --snapshot /tmp/launch_flash_out.txt /tmp/il_old.txt /tmp/il_new.txt 2>/dev/null
