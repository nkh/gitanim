...
DESCRIPTION
    ...
    diffvim-pipeline driver (compute → postprocess → pace → animator)
    ...
    The demos exercised are:
      1. Small Python      — examples/01_small_python   (speed 2)
      2. Python Classes    — examples/32_python_classes  (speed 2)
      3. Large Python      — examples/33_large_python    (speed 5)
