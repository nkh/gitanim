...
- 🔧 **In Progress** — partially implemented or planned for current milestone
...
79. ✅ **Add a test for parser equivalence** — ensure both parsers produce identical char ops for the same input, with automatic regression detection. *(test_parsers.pl tests both parsers)*
